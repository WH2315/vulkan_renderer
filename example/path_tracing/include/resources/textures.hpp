...
public:
    ...
    [[nodiscard]] virtual glm::vec3 value(float u, float v, const glm::vec3& hit_point) const = 0;
};
...
public:
    ...
    [[nodiscard]] glm::vec3 value(float u, float v, const glm::vec3& hit_point) const override;
...
public:
    ...
    glm::vec3 value(float u, float v, const glm::vec3& hit_point) const override;
